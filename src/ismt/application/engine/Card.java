...
public class Card extends ImageView {
    ...
    public int positionX, positionY;    // sitio onde a carta deve ser desenhada
    ...
    public Card(int given_card_rank, int given_card_points, Suit given_card_suit) {
        ...
        if(ImageStore.card_face_images == null){
    ...
    public boolean has_biggerPoints_than(Card another_card) {

        // compara pelo numero da carta (rank)
        if (cardPoints == 0 && another_card.cardPoints == 0) {
            return is_greater_than(another_card);
        }

        return (cardPoints > another_card.cardPoints);
    }
    ...
    public JsonObjectBuilder getCardJSON(JsonBuilderFactory jsonBuilderFactory){
        ...
        jsonObject.add("cardRank", this.cardRank);
        jsonObject.add("cardSuit", this.cardSuit.name());
        jsonObject.add("cardPoints", this.cardPoints);
        jsonObject.add("positionX", this.positionX);
        jsonObject.add("positionY", this.positionY);
